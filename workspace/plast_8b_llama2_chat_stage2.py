...
model = dict(
    ...
    pretrained_pth="./work_dirs/plast_8b_llama2_chat/ckps_stage1/all2all",
    training_stage=2,
    ...
    layers_hidden_state=[-22, -20, -18, -16, -14, -12, -10, -8, -6, -4, -2, -1],
    w_hidden_states=[0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.5, 0.6, 0.7, 0.8, 0.9, 1],
    use_ot=True,
)
...
plast_train_dataset = dict(
    type=PLaSTDataset,
    offline_processed_text_folder='data/plast_covost2_processed_llama2',
    tsv_dir=tsv_dir,
    tokenizer=tokenizer,
    with_asr=True,
    # debug=True,
...
test_evaluator = dict(
    ...
    dump_dir='work_dirs/plast_8b_llama2_chat/evaluate',
    epoch_num=f'_plast8b_e1_{test_lang}_en'
)
